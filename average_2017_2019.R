################################################################################
## Age-standardised mortality rates (ASMR) 2011-2023, baseline = mean 2017-2019,
...
tbl_html <- dev_tbl_col %>%
  kbl(format = "html", escape = FALSE,
      caption = "Percent deviation of ASMR from the 2017-2019 average baseline  
...
## 6 ────────────────────────────────────────────────────────────────────────────
##  Plot: observed ASMR, constant 2017-2019 average baseline, % deviation label
ggplot(asmr_pred, aes(year, ASMR)) +
  ...
  labs(
    title    = "Age-standardised mortality rates vs. 2017-2019 average baseline",
